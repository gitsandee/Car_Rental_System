      ...
      <div className="add_ward">
           ...
           <center><h1>UPDATE WARD</h1></center>
             ...
             {/* <div className="gl-0">
              ...
              <div className="gl-0">
                  <label for="ward-id" className="form-label">Ward ID</label>
              ...
              <div className="gl-1">
                  ...
                  <input type="text" className="form-control" id="ward_name" placeholder="Enter Ward Name" name="ward_name" value ={ward_name}  onChange={(e)=>onInputChange(e)} required/>
              </div>

              <div className="gl-2">
                  <label for="ward_catogory" className="form-label">Ward Catogory</label>
                  <input type="text" className="form-control" id="ward_catogory" placeholder="Enter Ward Catogory" name="ward_catogory" value ={ward_catogory}  onChange={(e)=>onInputChange(e)} required/>
              </div>

              <div className="gl-3">
                  <label for="total_bed_amount" className="form-label">Total Bed Amount</label>
                  <input type="text" className="form-control" id="total_bed_amount" placeholder="Enter Total Bed Amount" name="total_bed_amount" value ={total_bed_amount}  onChange={(e)=>onInputChange(e)} required/>
              </div>

              <div className="gl-4">
                  <label for="empty_beds" className="form-label">Enter Empty Beds Amount</label>
                  <input type="text" className="form-control" id="empty_beds" placeholder="Enter Empty Bed Amount" name="empty_beds" value ={empty_beds}  onChange={(e)=>onInputChange(e)} required/>
              </div>
